...
\usepackage{bm}
%  \usepackage{../../preamble_files/Paper_preamble}
...
\fancyhead[CO]{\small\scshape Second-order inductive inference}% odd page header 
...
\begin{abstract}%\resetlinenumber
  ...
  % substantial body of psycholog\
  % Our results provide a foundation through which tical and neuroscientific evidence that
  % demonstrates an inverse relationship between novelty and transitivity.
  % Potential applications feature novel situations where accuracy is valuable
  % and revisions are costly or slow. For instance, the generation of search
  % engine results pages; zero-day cyberattacks; and no-arbitrage bond pricing.
\end{abstract}
    % \newpage
