...
%Thus, $\rho_{r, j}^{\textup{inv}} $ lies in the range $-9$ to $-1.1$.
...
%	  = \left(
%      \alpha_{r, i} ^ {\textup{Y},x} \cdot x ^ {\,\rho^{\textup{out}}}
%      + \alpha_{r, i} ^ {\textup{Y},y} \cdot y ^ {\,\rho^{\textup{out}}}
%      + \alpha_{r, i} ^ {\textup{Y},z} \cdot z ^ {\,\rho^{\textup{out}}}
...
%%          \cdot \mathbf{C}_{r, i, n + t} ^ {\,\rho_{r}^\textup{utl}}
