...
\]
%= (\hat{\sigma}_{ij, r}^{\textup{inv}}) ^ {1 / \varepsilon_{j, r}^{\textup{inv}}}$
...
%	  = \left(
%      \alpha_{i, r} ^ {\textup{Y},x} \cdot x ^ {\,\rho^{\textup{out}}}
%      + \alpha_{i, r} ^ {\textup{Y},y} \cdot y ^ {\,\rho^{\textup{out}}}
%      + \alpha_{i, r} ^ {\textup{Y},z} \cdot z ^ {\,\rho^{\textup{out}}}
